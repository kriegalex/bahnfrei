...
| 2026-08-06 | Tech lead (release-0.1 run, §1–§3, post-M4 `main`) | UBS Kids Cup template seed + custom high-jump meet (vertical family), real forms incl. invalid-date / invalid-mark / reason-missing error cases; 360×740 and 1280×800 (Playwright) | **0 Critical, 0 Major, 4 Minor** (N1 check-in heading unlocalized, N2 contradictory entries empty-state copy, N3 filter-count pluralization, N4 21 px locale select — WCAG-conformant via spacing exception) — see `docs/delivery/usability-audit-2026-08-r01.md`; both walkthrough Criticals verified fixed live | **Zero open Critical findings — UC-038 #3 satisfied for the 0.1 tag** (subject to founder ratification of the proposed STR-046/SYS-147–153) |
